*&---------------------------------------------------------------------*
*& Report /THKR/BCS_KF_FG_FLD_DOWN_UP
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT /THKR/BCS_KF_FG_FLD_DOWN_UP.
...
TYPES: BEGIN OF ty_upload.
         INCLUDE STRUCTURE /THKR/KF_FG_FLD.
  ...
  LOOP AT it_file INTO ls_file.
    ...
    IF ls_file-data IS NOT INITIAL.
      SPLIT ls_file-data  AT p_split INTO
          ls_upload-mandt
          ls_upload-applic
          ls_upload-datasource
          ls_upload-fieldgroup
          ls_upload-fieldname
          ls_upload-sign
          ls_upload-maxperiod
          ls_upload-description
            .

      ls_upload-mandt = sy-mandt.  " ersetzen gegen den aktuellen Mandanten
...
*-----------------------------------------------------*
  LOOP AT it_upload ASSIGNING FIELD-SYMBOL(<fs_upload>).
    ...
    CONCATENATE
        <fs_upload>-mandt
        <fs_upload>-applic
        <fs_upload>-datasource
        <fs_upload>-fieldgroup
        <fs_upload>-fieldname
        <fs_upload>-sign
        <fs_upload>-maxperiod
        <fs_upload>-description
