*&---------------------------------------------------------------------*
*& Report /THKR/BCS_KF_REPTERM_DOWN_UP
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT /thkr/bcs_kf_repterm_down_up.
...
TYPES: BEGIN OF ty_upload.
         INCLUDE STRUCTURE /thkr/kf_repterm.
  ...
  LOOP AT it_file INTO ls_file.
    ...
    IF ls_file-data IS NOT INITIAL.
      SPLIT ls_file-data  AT p_split INTO
          ...
          ls_upload-rrcty
          ls_upload-ryear
          ls_upload-ceffyear_9
          ls_upload-wfstate_9
          ls_upload-alloctype_9
          ls_upload-valtype_9
          ls_upload-process_9
          ls_upload-budtype_9
            .
...
*-----------------------------------------------------*
  LOOP AT it_upload ASSIGNING FIELD-SYMBOL(<fs_upload>).
    ...
    CONCATENATE
        ...
        <fs_upload>-rrcty
        <fs_upload>-ryear
        <fs_upload>-ceffyear_9
        <fs_upload>-wfstate_9
        <fs_upload>-alloctype_9
        <fs_upload>-valtype_9
        <fs_upload>-process_9
        <fs_upload>-budtype_9
