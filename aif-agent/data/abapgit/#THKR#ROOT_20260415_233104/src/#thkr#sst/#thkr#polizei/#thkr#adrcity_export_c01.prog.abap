...
CLASS lcl_appl IMPLEMENTATION.
  ...
  ENDMETHOD.
  METHOD get_data.
    SELECT adrpcdcity~country, adrpcdcity~post_code, adrcityt~city_name AS city
      FROM adrpcdcity
        LEFT JOIN adrcityt ON adrpcdcity~country    = adrcityt~country   AND
                               adrpcdcity~city_code  = adrcityt~city_code AND
                               adrcityt~langu        = @sy-langu
