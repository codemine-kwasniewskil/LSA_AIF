*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/THKR/V_GI_MC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/THKR/V_GI_MC       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/THKR/V_GI_MC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /THKR/V_GI_MC_EXTRACT
TOTAL = /THKR/V_GI_MC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/THKR/V_GI_MC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/THKR/V_GI_MC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /THKR/V_GI_MC_EXTRACT
TOTAL = /THKR/V_GI_MC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/THKR/V_GI_MC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/THKR/V_GI_MC'
...
TOTAL = /THKR/V_GI_MC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/THKR/V_GI_MC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/THKR/V_GI_MC-UPD_FLAG NE SPACE.
