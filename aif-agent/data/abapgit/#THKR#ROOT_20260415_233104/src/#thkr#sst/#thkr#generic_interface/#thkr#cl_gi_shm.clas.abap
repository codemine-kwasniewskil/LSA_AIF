class /THKR/CL_GI_SHM definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value '/THKR/CL_GI_SHM' ##NO_TEXT.
  data ROOT type ref to /THKR/CL_GI_SHM_BUFFER read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to /THKR/CL_GI_SHM
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to /THKR/CL_GI_SHM_BUFFER
    raising
...
CLASS /THKR/CL_GI_SHM IMPLEMENTATION.
