FUNCTION /thkr/aif_zallge_chk_vr_needed .
*"----------------------------------------------------------------------
...
*"----------------------------------------------------------------------
  ...
  "ERROR = TRUE -> Keine Verrechnung durchführen. Ausgleich über KIDICAP
  "ERROR = FALSE -> Führe Verrechnung durch. Ausgleich über Verrechnung


  error = /thkr/cl_biene_processing=>get_instance( )->check_vr_needed( iv_kapitel = conv ZNSI_KAPITEL( data_line-10_kap ) iv_titel = data_line-11_titel  ).
