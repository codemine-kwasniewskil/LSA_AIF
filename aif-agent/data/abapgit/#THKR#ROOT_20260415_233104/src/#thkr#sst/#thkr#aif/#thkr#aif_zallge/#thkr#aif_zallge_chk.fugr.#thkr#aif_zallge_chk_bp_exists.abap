FUNCTION /THKR/AIF_ZALLGE_CHK_BP_EXISTS .
*"----------------------------------------------------------------------
...
*"----------------------------------------------------------------------
"Prüfung, ob der Geschäftspartner bereits existiert.
"Wenn nein, dann anlegen.
"wenn ja, keine weitere Verarbeitung. Status auf S (Erfolgreich setzen)
  ...
  error = lo_chk_burks->check_bp_does_not_exist(
            EXPORTING
              is_curr_line  = <ls_curr>                 " AIF SAP Struktur für Geschäftspartner
            CHANGING
              ct_return_tab = return_tab[]                 " Tabellentyp für BAPIRET2
              ct_data       = <lt_data>                 " Output Struktur
          ).
ENDFUNCTION.
