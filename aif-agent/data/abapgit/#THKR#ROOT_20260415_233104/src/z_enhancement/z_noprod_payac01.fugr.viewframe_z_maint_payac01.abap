*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_Z_MAINT_PAYAC01
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_Z_MAINT_PAYAC01     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_Z_MAINT_PAYAC01'
         EXPORTING
              FCODE          = READ
...
EXTRACT = Z_MAINT_PAYAC01_EXTRACT
TOTAL = Z_MAINT_PAYAC01_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_Z_MAINT_PAYAC01'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_Z_MAINT_PAYAC01-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = Z_MAINT_PAYAC01_EXTRACT
TOTAL = Z_MAINT_PAYAC01_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_Z_MAINT_PAYAC01-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_Z_MAINT_PAYAC01'
...
TOTAL = Z_MAINT_PAYAC01_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_Z_MAINT_PAYAC01-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_Z_MAINT_PAYAC01-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_Z_MAINT_PAYAC01'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_Z_MAINT_PAYAC01-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = Z_MAINT_PAYAC01_EXTRACT
TOTAL = Z_MAINT_PAYAC01_TOTAL
