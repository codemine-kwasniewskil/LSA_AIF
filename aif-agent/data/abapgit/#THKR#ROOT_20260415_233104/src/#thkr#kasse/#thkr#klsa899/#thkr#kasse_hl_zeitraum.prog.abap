...
** Fill and show ALV
  TRY.
      DATA(alv) = NEW /thkr/cl_b_hl_zeitraum_alv_ctr( fonds = p_fcode s_kapitel = s_cap[] s_titel = s_titel[] komplement = p_neg s_valut = s_valut[] ).
      alv->display_data( ).
