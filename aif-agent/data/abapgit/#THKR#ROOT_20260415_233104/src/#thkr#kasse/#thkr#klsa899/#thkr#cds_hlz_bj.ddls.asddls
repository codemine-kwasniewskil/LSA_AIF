...
define view entity /THKR/CDS_HLZ_BJ
  as select from    /THKR/CDS_HLGFMIFIIT as fmi
   ...
   left outer join /THKR/CDS_BJBSEG3     as bsegVAL on  bkpf.DocumentReferenceID = bsegVAL.xblnr
                                                    and fmi.bukrs                = bsegVAL.bukrs
                                                    and fmi.knbelnr              = bsegVAL.belnr
                                                    and fmi.kngjahr              = bsegVAL.gjahr
  //  and fmi.wrttp   = '61'
