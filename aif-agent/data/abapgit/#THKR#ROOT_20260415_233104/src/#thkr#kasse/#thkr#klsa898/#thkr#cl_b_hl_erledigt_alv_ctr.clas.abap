class /THKR/CL_B_HL_ERLEDIGT_ALV_CTR definition
  public
...
CLASS /THKR/CL_B_HL_ERLEDIGT_ALV_CTR IMPLEMENTATION.
...
** Base select statement
    DATA(where) = |fikrs = 1000 AND  epl = @me->fonds AND kapitel IN @me->s_kapitel AND titel IN @me->s_titel AND erledigungsdatum IN @me->s_augdt|.
...
** Store data
  ...
  method SET_ALV_HEADER.
    ...
    me->salv->get_display_settings( )->set_list_header( |Geldhinterlegung Erledigt:  { kapitel } { title_text }| ).
  endmethod.
